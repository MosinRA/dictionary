...
import com.mosin.dictionary.view.history.HistoryInteractor
import com.mosin.dictionary.view.history.HistoryViewModel
...
val application = module {
    single { Room.databaseBuilder(get(), HistoryDataBase::class.java, "dbHistory")
        .build() }
